          ...
          <div className="insurance-hero__right">
            <div className="insurance-snapshot">
              ...
              <div className="insurance-snapshot__call">
                Prefer to chat first? Call <a href="tel:+18303539921">+1 (830) 353-9921</a> or <a href="tel:+18303771366">+1 (830) 377-1366</a> for personalized coverage.
              </div>
            </div>
          </div>
        </div>
                  ...
                  {orderData.method === 'Debit / Prepaid Card' ? (
                    <>
                      ...
                      <ul>
                        ...
                        <li>Call <a href="tel:+18303539921">+1 (830) 353-9921</a> or <a href="tel:+18303771366">+1 (830) 377-1366</a> and provide your order number to our support team.</li>
