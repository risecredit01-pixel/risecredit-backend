          ...
          <div className="tailored__right">
            <div className="tailored__card">
              ...
              <div className="tailored__card-actions">
                ...
                <a href="mailto:risecredit01@gmail.com" className="btn btn-outline">Ask About Discounts</a>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="confirmation-instructions">
                  {orderData.method === 'Debit / Prepaid Card' ? (
                    ...
                    <>
                      ...
                      <p>After sending, email your transaction screenshot to <a href="mailto:risecredit01@gmail.com">risecredit01@gmail.com</a>.</p>
                    </>
                  )}
                </div>
